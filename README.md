...
Pin cushion is a debugging tool for catching the game's event system events ("pins") in a convenient manner.

## Installation Instructions

1. Download the latest version of [ZHMModSDK](https://github.com/OrfeasZ/ZHMModSDK) and install it.
2. Download the latest version of `PinCushion` and copy the DLL to the ZHMModSDK `mods` folder (e.g. `C:\Games\HITMAN 3\Retail\mods`).
